...
runtime_socket_path = "${RUNTIME_SOCKET_PATH:-/var/run/docker.sock}"
...
print_success() {
    ...
    echo ""
    info "Edit /etc/escluse/config.toml to set backend_url and api_key before running the agent."
}
