...
**Wave 1** *(parallel — no file overlap)*
- [ ] 72-01-PLAN.md — DB Migration + API Backend: bedrock game_types row, dynamic image dispatch, game_type→mc_loader mapping
- [ ] 72-02-PLAN.md — Agent Runtime: UDP port binding for Bedrock, dynamic port map key, loader field forwarding
- [ ] 72-03-PLAN.md — Frontend UI: Bedrock option in CreateServerModal, conditional field rendering
